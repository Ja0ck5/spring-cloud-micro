...
import com.ja0ck5.config.UserRibbonConfiguration;
...
public class SpringCloudMicroConsumerMovieRibbonApplication {
	...
	@Primary
	@Bean
	@LoadBalanced // 加了这个注解才能解决 更具服务名称发现服务。http://SPRING-CLOUD-MICRO-PROVIDER-USER/
	RestTemplate restTemplate() {
		return new RestTemplate();
	}

	public static void main(String[] args) {
		SpringApplication.run(SpringCloudMicroConsumerMovieRibbonApplication.class, args);
	}
}
